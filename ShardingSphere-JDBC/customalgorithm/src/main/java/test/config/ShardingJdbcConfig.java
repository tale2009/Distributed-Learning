...
@Import(value ={DataSourcePeoperty.class,
        ...
        CustomReadwriteSplittingDataSourceRuleConfiguration.class})
@Configuration
public class ShardingJdbcConfig {
    ...
    @Autowired
    private CustomReadwriteSplittingDataSourceRuleConfiguration customReadwriteSplittingDataSourceRuleConfiguration;
    ...
    private DataSource buildDataSource() throws SQLException {
        ...
        ReadwriteSplittingRuleConfiguration splittingRuleConfiguration = createSplittingRuleConfiguration();
        ruleConfigurationList.add(splittingRuleConfiguration);
    ...
    private ReadwriteSplittingRuleConfiguration createSplittingRuleConfiguration()
    {
        ReadwriteSplittingDataSourceRuleConfiguration dataSourceRuleConfiguration = new ReadwriteSplittingDataSourceRuleConfiguration(
                customReadwriteSplittingDataSourceRuleConfiguration.getName(),
                customReadwriteSplittingDataSourceRuleConfiguration.getAutoAwareDataSourceName(),
                customReadwriteSplittingDataSourceRuleConfiguration.getWriteDataSourceName(),
                customReadwriteSplittingDataSourceRuleConfiguration.getReadDataSourceNames(),
                customReadwriteSplittingDataSourceRuleConfiguration.getLoadBalancerName());
